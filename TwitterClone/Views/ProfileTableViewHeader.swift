...
//  TwitterClone
//
//  Created by Jean Ricardo Cesca on 14/07/22.
//
...
class ProfileTableViewHeader: UIView {
    ...
    private func configureConstraints() {
        ...
        let followingCountLabelContraints = [
        ...
        NSLayoutConstraint.activate(followingCountLabelContraints)

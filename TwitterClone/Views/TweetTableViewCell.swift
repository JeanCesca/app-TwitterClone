...
class TweetTableViewCell: UITableViewCell {
    ...
    private let tweetTextContentLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Alguma frase de tweet para testar as propriedades numberOfLines = 0 e lineBreakMode byWordWrapping"
    ...
    private func configureConstraints() {
        ...
        let displayNameLabelContraints = [
        ...
        NSLayoutConstraint.activate(displayNameLabelContraints)
        NSLayoutConstraint.activate(tweetTextContentLabelConstraints)
        NSLayoutConstraint.activate(replyButtonConstraints)
        NSLayoutConstraint.activate(retweetButtonContraints)
        NSLayoutConstraint.activate(likeButtonContraints)
